    ...
    Promise.all(Array.from(document.images).map(img => {
        ...
        return new Promise(resolve => {
            ...
            img.addEventListener('error', () => {
              ...
              div.style = "max-width:25%;max-height:25%;margin:auto;text-align:center;";
              ...
              '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 40 32" enable-background="new 0 0 40 32" xml:space="preserve">'+
                '<g>'+
             ...
             //img.src = "data:image/svg+xml," + encodeURIComponent(svgtext);
              ...
              if (alttext !== null && alttext !== ""){
                ...
                p.style = "border: 1px solid black;margin:0px;padding:0px;text-align:left;"
                p.innerText = "alttext:" + alttext;
                // append after
                //img.parentNode.insertBefore(p, img.nextSibling);
                div.appendChild(p);
              }
